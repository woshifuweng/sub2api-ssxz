...
7. Keep image generation release gates explicit:
   ...
   - service-level and handler-level upstream failure regression tests exist; DB-backed image-history regression exists; DB-backed usage/billing regression can be added before production
