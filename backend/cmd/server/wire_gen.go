...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	chatWorkspaceService := service.ProvideChatWorkspaceServiceWithSub2APITextBridge(chatWorkspaceRepository, configConfig, channelService, workspaceSub2APITextBridge)
