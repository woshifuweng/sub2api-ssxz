...
func init() {
	...
	paymentorderDescIdempotencyKey := paymentorderFields[14].Descriptor()
	...
	// paymentorderDescIdempotencyRequestHash is the schema descriptor for idempotency_request_hash field.
	paymentorderDescIdempotencyRequestHash := paymentorderFields[15].Descriptor()
	// paymentorder.IdempotencyRequestHashValidator is a validator for the "idempotency_request_hash" field. It is called by the builders before save.
	paymentorder.IdempotencyRequestHashValidator = paymentorderDescIdempotencyRequestHash.Validators[0].(func(string) error)
