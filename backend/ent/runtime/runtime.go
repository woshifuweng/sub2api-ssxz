...
func init() {
	...
	groupDescSoraStorageQuotaBytes := groupFields[16].Descriptor()
	...
	userDescUnlimitedConcurrency := userFields[6].Descriptor()
	...
	userDescSoraStorageQuotaBytes := userFields[22].Descriptor()
	...
	userDescSoraStorageUsedBytes := userFields[23].Descriptor()
