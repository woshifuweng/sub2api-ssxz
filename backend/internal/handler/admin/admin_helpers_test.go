...
func TestAffiliateSettingsAreAcceptedAndAudited(t *testing.T) {
	...
	require.NoError(t, err)
	require.NotNil(t, req.AffiliateEnabled)
	...
	}, diffSettings(before, after, &service.AuthSourceDefaultSettings{}, &service.AuthSourceDefaultSettings{}, req))
}
...
func TestBuildSystemSettingsDTOExposesAffiliateSettings(t *testing.T) {
	...
	settingsDTO := handler.buildSystemSettingsDTO(context.Background(), &service.SystemSettings{
