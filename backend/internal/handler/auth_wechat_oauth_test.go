...
func (s *wechatOAuthRefreshTokenCacheStub) StoreConsumedRefreshTokenFamily(context.Context, string, string, time.Duration) error {
	return nil
}

func (s *wechatOAuthRefreshTokenCacheStub) GetConsumedRefreshTokenFamily(context.Context, string) (string, bool, error) {
	return "", false, nil
}
