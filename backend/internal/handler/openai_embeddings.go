	...
	for {
		...
		if err != nil {
			...
			if errors.As(err, &failoverErr) {
				...
				h.gatewayService.ReportOpenAIAccountModelScheduleResult(account.ID, account.GetMappedModel(reqModel), false, nil)
				if failoverClientGone(c) {
		...
		h.gatewayService.ReportOpenAIAccountModelScheduleResult(account.ID, account.GetMappedModel(reqModel), true, nil)
