...
func executableAdminFeatureRoutes(h *handler.Handlers) []gatewayctx.RouteDef {
	...
	if h.Reseller != nil {
		out = append(out,
			gatewayctx.RouteDef{Method: http.MethodGet, Path: "/api/v1/admin/reseller/agents", Handler: h.Reseller.AdminListAgentsGateway, Middleware: mw},
			gatewayctx.RouteDef{Method: http.MethodGet, Path: "/api/v1/admin/reseller/agents/:id", Handler: h.Reseller.AdminGetAgentDetailGateway, Middleware: mw},
			gatewayctx.RouteDef{Method: http.MethodGet, Path: "/api/v1/admin/reseller/agents/:id/recruits", Handler: h.Reseller.AdminGetAgentRecruitsGateway, Middleware: mw},
			gatewayctx.RouteDef{Method: http.MethodPatch, Path: "/api/v1/admin/reseller/agents/:id", Handler: h.Reseller.AdminUpdateAgentGateway, Middleware: mw},
			gatewayctx.RouteDef{Method: http.MethodPost, Path: "/api/v1/admin/reseller/agents/:id/disable", Handler: h.Reseller.AdminDisableAgentGateway, Middleware: mw},
			gatewayctx.RouteDef{Method: http.MethodPost, Path: "/api/v1/admin/reseller/agents/:id/enable", Handler: h.Reseller.AdminEnableAgentGateway, Middleware: mw},
			gatewayctx.RouteDef{Method: http.MethodPost, Path: "/api/v1/admin/reseller/agents/:id/role", Handler: h.Reseller.AdminGrantRoleGateway, Middleware: mw},
			gatewayctx.RouteDef{Method: http.MethodDelete, Path: "/api/v1/admin/reseller/agents/:id/role", Handler: h.Reseller.AdminRevokeRoleGateway, Middleware: mw},
			gatewayctx.RouteDef{Method: http.MethodGet, Path: "/api/v1/admin/reseller/withdrawals", Handler: h.Reseller.AdminListWithdrawalsGateway, Middleware: mw},
			gatewayctx.RouteDef{Method: http.MethodPost, Path: "/api/v1/admin/reseller/withdrawals/:id/review", Handler: h.Reseller.AdminReviewWithdrawalGateway, Middleware: mw},
		)
	}
