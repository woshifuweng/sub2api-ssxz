...
func newGatewayRoutesTestRouterWithConfig(cfg *config.Config, platform ...string) *gin.Engine {
	...
	return newGatewayRoutesTestRouterCore(cfg, nil, &service.Group{Platform: groupPlatform})
}
...
func newGatewayRoutesTestRouterWithGroup(redisClient *redis.Client, group *service.Group) *gin.Engine {
	return newGatewayRoutesTestRouterCore(&config.Config{}, redisClient, group)
}

func newGatewayRoutesTestRouterCore(cfg *config.Config, redisClient *redis.Client, group *service.Group) *gin.Engine {
