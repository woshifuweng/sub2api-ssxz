...
type AdminService interface {
	...
	// RevertAccountProxyFallback switches an account back to its pre-fallback proxy.
...
func NewAdminService(
	...
	if billingRepo, ok := accountRepo.(AccountBillingSettingsRepository); ok {
		impl.accountBillingRepo = billingRepo
	}
	if duplicateRepo, ok := groupRepo.(GroupDuplicateRepository); ok {
		impl.groupDuplicateRepo = duplicateRepo
	}
	return impl
}

// User management implementations
func (s *adminServiceImpl) ListUsersLegacy(ctx context.Context, page, pageSize int, filters UserListFilters) ([]User, int64, error) {
...
func (s *adminServiceImpl) loadUserGroupRatesOneByOneLegacy(ctx context.Context, users []User) {
...
func (s *adminServiceImpl) GetUserLegacy(ctx context.Context, id int64) (*User, error) {
...
func (s *adminServiceImpl) CreateUserLegacy(ctx context.Context, input *CreateUserInput) (*User, error) {
...
func (s *adminServiceImpl) assignDefaultSubscriptionsLegacy(ctx context.Context, userID int64) {
...
func (s *adminServiceImpl) UpdateUserLegacy(ctx context.Context, id int64, input *UpdateUserInput) (*User, error) {
	user, err := s.userRepo.GetByID(ctx, id)
	if err != nil {
		return nil, err
	}
...
func (s *adminServiceImpl) DeleteUserLegacy(ctx context.Context, id int64) error {
...
func (s *adminServiceImpl) UpdateUserBalanceLegacy(ctx context.Context, userID int64, balance float64, operation string, notes string) (*User, error) {
...
func (s *adminServiceImpl) GetUserAPIKeysLegacy(ctx context.Context, userID int64, page, pageSize int) ([]APIKey, int64, error) {
	params := pagination.PaginationParams{Page: page, PageSize: pageSize}
...
func (s *adminServiceImpl) GetUserUsageStatsLegacy(ctx context.Context, userID int64, period string) (any, error) {
...
// GetUserBalanceHistory returns paginated balance/concurrency change records for a user.
func (s *adminServiceImpl) GetUserBalanceHistoryLegacy(ctx context.Context, userID int64, page, pageSize int, codeType string) ([]RedeemCode, int64, float64, error) {
	params := pagination.PaginationParams{Page: page, PageSize: pageSize}
...
func (s *adminServiceImpl) ListGroupsLegacy(ctx context.Context, page, pageSize int, platform, status, search string, isExclusive *bool) ([]Group, int64, error) {
	params := pagination.PaginationParams{Page: page, PageSize: pageSize}
...
func (s *adminServiceImpl) GetAllGroupsLegacy(ctx context.Context) ([]Group, error) {
	return s.groupRepo.ListActive(ctx)
}

func (s *adminServiceImpl) GetAllGroupsByPlatformLegacy(ctx context.Context, platform string) ([]Group, error) {
	return s.groupRepo.ListActiveByPlatform(ctx, platform)
}

func (s *adminServiceImpl) GetGroupLegacy(ctx context.Context, id int64) (*Group, error) {
	return s.groupRepo.GetByID(ctx, id)
}

func (s *adminServiceImpl) CreateGroupLegacy(ctx context.Context, input *CreateGroupInput) (*Group, error) {
	...
	if fallbackGroupID != nil {
		if err := s.validateFallbackGroupLegacy(ctx, 0, platform, *fallbackGroupID); err != nil {
			return nil, err
		}
	}
...
func normalizeLimitLegacy(limit *float64) *float64 {
...
func normalizePriceLegacy(price *float64) *float64 {
...
func (s *adminServiceImpl) validateFallbackGroupLegacy(ctx context.Context, currentGroupID int64, currentPlatform string, fallbackGroupID int64) error {
	// 不能将自己设置为兜底分组
...
// fallbackGroupID: 兜底分组 ID
func (s *adminServiceImpl) validateFallbackGroupOnInvalidRequestLegacy(ctx context.Context, currentGroupID int64, platform, subscriptionType string, fallbackGroupID int64) error {
...
func (s *adminServiceImpl) UpdateGroupLegacy(ctx context.Context, id int64, input *UpdateGroupInput) (*Group, error) {
	...
	if fallbackGroupID != nil {
		if err := s.validateFallbackGroupLegacy(ctx, id, group.Platform, *fallbackGroupID); err != nil {
			return nil, err
		}
	}
...
func (s *adminServiceImpl) DeleteGroupLegacy(ctx context.Context, id int64) error {
...
func (s *adminServiceImpl) GetGroupAPIKeysLegacy(ctx context.Context, groupID int64, page, pageSize int) ([]APIKey, int64, error) {
	params := pagination.PaginationParams{Page: page, PageSize: pageSize}
...
func (s *adminServiceImpl) GetGroupRateMultipliersLegacy(ctx context.Context, groupID int64) ([]UserGroupRateEntry, error) {
	if s.userGroupRateRepo == nil {
		return nil, nil
	}
...
func (s *adminServiceImpl) ClearGroupRateMultipliersLegacy(ctx context.Context, groupID int64) error {
	if s.userGroupRateRepo == nil {
		return nil
	}
...
func (s *adminServiceImpl) BatchSetGroupRateMultipliersLegacy(ctx context.Context, groupID int64, entries []GroupRateMultiplierInput) error {
	if s.userGroupRateRepo == nil {
		return nil
	}
...
func (s *adminServiceImpl) UpdateGroupSortOrdersLegacy(ctx context.Context, updates []GroupSortOrderUpdate) error {
	return s.groupRepo.UpdateSortOrders(ctx, updates)
}

// AdminUpdateAPIKeyGroupID 管理员修改 API Key 分组绑定
// groupID: nil=不修改, 指向0=解绑, 指向正整数=绑定到目标分组
func (s *adminServiceImpl) AdminUpdateAPIKeyGroupIDLegacy(ctx context.Context, keyID int64, groupID *int64) (*AdminUpdateAPIKeyGroupIDResult, error) {
...
func (s *adminServiceImpl) ReplaceUserGroupLegacy(ctx context.Context, userID, oldGroupID, newGroupID int64) (*ReplaceUserGroupResult, error) {
...
func (s *adminServiceImpl) ListAccountsLegacy(ctx context.Context, page, pageSize int, platform, accountType, status, search, plan, oauthType, tierID string, groupID int64) ([]Account, int64, error) {
	params := pagination.PaginationParams{Page: page, PageSize: pageSize}
...
func (s *adminServiceImpl) GetAccountLegacy(ctx context.Context, id int64) (*Account, error) {
	return s.accountRepo.GetByID(ctx, id)
}

func (s *adminServiceImpl) GetAccountsByIDsLegacy(ctx context.Context, ids []int64) ([]*Account, error) {
	if len(ids) == 0 {
		return []*Account{}, nil
	}
...
func (s *adminServiceImpl) CreateAccountLegacy(ctx context.Context, input *CreateAccountInput) (*Account, error) {
	// 绑定分组
...
func (s *adminServiceImpl) UpdateAccountLegacy(ctx context.Context, id int64, input *UpdateAccountInput) (*Account, error) {
...
func (s *adminServiceImpl) BulkUpdateAccountsLegacy(ctx context.Context, input *BulkUpdateAccountsInput) (*BulkUpdateAccountsResult, error) {
...
func (s *adminServiceImpl) RefreshAccountCredentialsLegacy(ctx context.Context, id int64) (*Account, error) {
	account, err := s.accountRepo.GetByID(ctx, id)
	if err != nil {
		return nil, err
	}
...
func (s *adminServiceImpl) ClearAccountErrorLegacy(ctx context.Context, id int64) (*Account, error) {
...
func (s *adminServiceImpl) SetAccountErrorLegacy(ctx context.Context, id int64, errorMsg string) error {
	return s.accountRepo.SetError(ctx, id, errorMsg)
}

func (s *adminServiceImpl) SetAccountSchedulableLegacy(ctx context.Context, id int64, schedulable bool) (*Account, error) {
...
func (s *adminServiceImpl) ListProxiesLegacy(ctx context.Context, page, pageSize int, protocol, status, search string) ([]Proxy, int64, error) {
	params := pagination.PaginationParams{Page: page, PageSize: pageSize}
...
func (s *adminServiceImpl) ListProxiesWithAccountCountLegacy(ctx context.Context, page, pageSize int, protocol, status, search string) ([]ProxyWithAccountCount, int64, error) {
	params := pagination.PaginationParams{Page: page, PageSize: pageSize}
...
func (s *adminServiceImpl) GetAllProxiesLegacy(ctx context.Context) ([]Proxy, error) {
	return s.proxyRepo.ListActive(ctx)
}

func (s *adminServiceImpl) GetAllProxiesWithAccountCountLegacy(ctx context.Context) ([]ProxyWithAccountCount, error) {
...
func (s *adminServiceImpl) GetProxyLegacy(ctx context.Context, id int64) (*Proxy, error) {
	return s.proxyRepo.GetByID(ctx, id)
}

func (s *adminServiceImpl) GetProxiesByIDsLegacy(ctx context.Context, ids []int64) ([]Proxy, error) {
	return s.proxyRepo.ListByIDs(ctx, ids)
}

func (s *adminServiceImpl) CreateProxyLegacy(ctx context.Context, input *CreateProxyInput) (*Proxy, error) {
	proxy := &Proxy{
		Name:     input.Name,
...
func (s *adminServiceImpl) UpdateProxyLegacy(ctx context.Context, id int64, input *UpdateProxyInput) (*Proxy, error) {
...
func (s *adminServiceImpl) DeleteProxyLegacy(ctx context.Context, id int64) error {
...
func (s *adminServiceImpl) BatchDeleteProxiesLegacy(ctx context.Context, ids []int64) (*ProxyBatchDeleteResult, error) {
...
func (s *adminServiceImpl) GetProxyAccountsLegacy(ctx context.Context, proxyID int64) ([]ProxyAccountSummary, error) {
	return s.proxyRepo.ListAccountSummariesByProxyID(ctx, proxyID)
}

func (s *adminServiceImpl) CheckProxyExistsLegacy(ctx context.Context, host string, port int, username, password string) (bool, error) {
	return s.proxyRepo.ExistsByHostPortAuth(ctx, host, port, username, password)
}

// Redeem code management implementations
func (s *adminServiceImpl) ListRedeemCodesLegacy(ctx context.Context, page, pageSize int, codeType, status, search string) ([]RedeemCode, int64, error) {
	params := pagination.PaginationParams{Page: page, PageSize: pageSize}
...
func (s *adminServiceImpl) GetRedeemCodeLegacy(ctx context.Context, id int64) (*RedeemCode, error) {
	return s.redeemCodeRepo.GetByID(ctx, id)
}

func (s *adminServiceImpl) GenerateRedeemCodesLegacy(ctx context.Context, input *GenerateRedeemCodesInput) ([]RedeemCode, error) {
...
func (s *adminServiceImpl) DeleteRedeemCodeLegacy(ctx context.Context, id int64) error {
	return s.redeemCodeRepo.Delete(ctx, id)
}

func (s *adminServiceImpl) BatchDeleteRedeemCodesLegacy(ctx context.Context, ids []int64) (int64, error) {
	var deleted int64
	for _, id := range ids {
...
func (s *adminServiceImpl) ExpireRedeemCodeLegacy(ctx context.Context, id int64) (*RedeemCode, error) {
...
func (s *adminServiceImpl) TestProxyLegacy(ctx context.Context, id int64) (*ProxyTestResult, error) {
	proxy, err := s.proxyRepo.GetByID(ctx, id)
	if err != nil {
		return nil, err
	}
...
func (s *adminServiceImpl) CheckProxyQualityLegacy(ctx context.Context, id int64) (*ProxyQualityCheckResult, error) {
	proxy, err := s.proxyRepo.GetByID(ctx, id)
	if err != nil {
		return nil, err
	}
...
func runProxyQualityTargetLegacy(ctx context.Context, client *http.Client, target proxyQualityTarget) ProxyQualityCheckItem {
...
func finalizeProxyQualityResultLegacy(result *ProxyQualityCheckResult) {
	if result == nil {
		return
	}
...
func proxyQualityGradeLegacy(score int) string {
	switch {
	case score >= 90:
		return "A"
	case score >= 75:
...
func proxyQualityOverallStatusLegacy(result *ProxyQualityCheckResult) string {
	if result == nil {
		return ""
	}
...
func proxyQualityFirstCFRayLegacy(result *ProxyQualityCheckResult) string {
	if result == nil {
		return ""
	}
...
func proxyQualityBaseConnectivityPassLegacy(result *ProxyQualityCheckResult) bool {
	if result == nil {
		return false
	}
	for _, item := range result.Items {
...
func (s *adminServiceImpl) saveProxyQualitySnapshotLegacy(ctx context.Context, proxyID int64, result *ProxyQualityCheckResult, exitInfo *ProxyExitInfo) {
	if result == nil {
		return
	}
	score := result.Score
...
func (s *adminServiceImpl) probeProxyLatencyLegacy(ctx context.Context, proxy *Proxy) {
...
// 如果存在混合，返回错误提示用户确认
func (s *adminServiceImpl) checkMixedChannelRiskLegacy(ctx context.Context, currentAccountID int64, currentAccountPlatform string, groupIDs []int64) error {
...
func (s *adminServiceImpl) validateGroupIDsExistLegacy(ctx context.Context, groupIDs []int64) error {
	if len(groupIDs) == 0 {
		return nil
	}
	if s.groupRepo == nil {
...
func (s *adminServiceImpl) attachProxyLatencyLegacy(ctx context.Context, proxies []ProxyWithAccountCount) {
...
func (s *adminServiceImpl) saveProxyLatencyLegacy(ctx context.Context, proxyID int64, info *ProxyLatencyInfo) {
...
func getAccountPlatformLegacy(accountPlatform string) string {
...
type mixedChannelErrorLegacy struct {
	GroupID         int64
	GroupName       string
...
func (e *mixedChannelErrorLegacy) Error() string {
	return fmt.Sprintf("mixed_channel_warning: Group '%s' contains both %s and %s accounts. Using mixed channels in the same context may cause thinking block signature validation issues, which will fallback to non-thinking mode for historical messages.",
		e.GroupName, e.CurrentPlatform, e.OtherPlatform)
}

func (s *adminServiceImpl) ResetAccountQuotaLegacy(ctx context.Context, id int64) error {
	return s.accountRepo.ResetQuotaUsed(ctx, id)
}

// EnsureOpenAIPrivacy 检查 OpenAI OAuth 账号是否已设置 privacy_mode，
// 未设置则调用 disableOpenAITraining 并持久化到 Extra，返回设置的 mode 值。
func (s *adminServiceImpl) EnsureOpenAIPrivacyLegacy(ctx context.Context, account *Account) string {
