...
type APIKeyRepository interface {
	...
	// DeleteWithAudit tombstones the key and soft-deletes it atomically without
	// retaining deleted credential material.
...
func (s *APIKeyService) Create(ctx context.Context, userID int64, req CreateAPIKeyRequest) (*APIKey, error) {
	if err := validateAPIKeyCreateLimits(req); err != nil {
		return nil, err
	}
...
func (s *APIKeyService) Update(ctx context.Context, id int64, userID int64, req UpdateAPIKeyRequest) (*APIKey, error) {
	...
	if err := validateAPIKeyUpdateLimits(req); err != nil {
		return nil, err
	}
	...
	// Update IP restrictions: nil keeps existing values, empty arrays clear them.
	if req.IPWhitelist != nil {
