...
// ProvideBalanceLedgerRepositories adapts the single repository provider to
// legacy optional constructor parameters while keeping production injection explicit.
func ProvideBalanceLedgerRepositories(repo BalanceLedgerRepository) []BalanceLedgerRepository {
	return []BalanceLedgerRepository{repo}
}
