...
func (s *BillingService) GetModelPricingWithChannel(model string, channelPricing *ChannelModelPricing) (*ModelPricing, error) {
	...
	// Preserve SSXZ's underbilling guard for catalog entries that omit cache-read
	// prices while still using upstream's Fast/Priority ratio-preserving overrides.
