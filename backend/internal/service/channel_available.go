...
func (s *ChannelService) fillGlobalPricingFallback(models []SupportedModel) {
	...
	for i := range models {
		...
		models[i].Pricing.ContextLength = lp.MaxInputTokens
		models[i].Pricing.MaxOutputTokens = lp.MaxOutputTokens
	}
}
...
func synthesizePricingFromLiteLLM(lp *LiteLLMModelPricing) *ChannelModelPricing {
	...
	return &ChannelModelPricing{
		...
		ContextLength:    lp.MaxInputTokens,
		MaxOutputTokens:  lp.MaxOutputTokens,
	}
}
