...
// getOpenAIRequestAccessToken preserves the normal OAuth/API-key token path
// while Agent Identity accounts authenticate later with a per-request signed
// assertion in buildOpenAIAuthenticationHeaders.
