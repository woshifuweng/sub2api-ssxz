...
func resolveOpenAIUpstreamOriginatorContext(c gatewayctx.GatewayContext, isOfficialClient bool) string {
	if c != nil {
...
func (s *OpenAIGatewayService) resolveOpenAIUpstreamOriginatorWithSample(ctx context.Context, c gatewayctx.GatewayContext, account *Account, isOfficialClient bool) string {
	...
	return resolveOpenAIUpstreamOriginatorContext(c, isOfficialClient)
}
