...
func TestHandlePaymentNotificationDoesNotDoubleFulfillBalanceOrder(t *testing.T) {
	...
	require.Equal(t, 0, countPaymentAuditLogs(t, client, order.ID, "AFFILIATE_REBATE_SUCCESS"))
}
...
func (r *paymentFulfillmentAffiliateRepo) AccrueQuota(_ context.Context, inviterID, inviteeUserID int64, amount float64, _ int, _ *int64) (bool, error) {
	r.accrueCalls++
