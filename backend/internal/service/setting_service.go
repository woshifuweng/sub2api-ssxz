...
func (s *SettingService) UpdateSettings(ctx context.Context, settings *SystemSettings) error {
	...
	updates[SettingKeyPurchaseLinkCNY10] = strings.TrimSpace(settings.PurchaseLinkCNY10)
	updates[SettingKeyPurchaseLinkCNY30] = strings.TrimSpace(settings.PurchaseLinkCNY30)
	updates[SettingKeyPurchaseLinkCNY100] = strings.TrimSpace(settings.PurchaseLinkCNY100)
