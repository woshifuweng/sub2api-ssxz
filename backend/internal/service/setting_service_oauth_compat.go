...
func (s *SettingService) GetChannelMonitorRuntimeLegacy(ctx context.Context) ChannelMonitorRuntime {
...
func (s *SettingService) GetAvailableChannelsRuntimeLegacy(ctx context.Context) AvailableChannelsRuntime {
...
func (s *SettingService) effectiveWeChatConnectOAuthConfigLegacy(settings map[string]string) WeChatConnectOAuthConfig {
...
func (s *SettingService) parseWeChatConnectOAuthConfigLegacy(settings map[string]string) (WeChatConnectOAuthConfig, error) {
...
func (s *SettingService) GetWeChatConnectOAuthConfigLegacy(ctx context.Context) (WeChatConnectOAuthConfig, error) {
...
func oidcUsePKCECompatibilityDefaultLegacy(base config.OIDCConnectConfig) bool {
...
func oidcValidateIDTokenCompatibilityDefaultLegacy(base config.OIDCConnectConfig) bool {
...
func (s *SettingService) GetOIDCConnectOAuthConfigLegacy(ctx context.Context) (config.OIDCConnectConfig, error) {
