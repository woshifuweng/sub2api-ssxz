...
- [ ] **Step 1: Add a sub-cent fee and minute-rounding fixture**
...
- [ ] **Step 2: Add visible-value assertions**
...
- [ ] **Step 1: Implement adaptive sub-cent display**
...
- [ ] **Step 2: Correct duration rounding**
...
- [ ] **Step 3: Snapshot each page load and ignore stale responses**

Add a module-local counter, increment it at load start, copy page/filter values into local constants, use those constants for API calls, and return before mutating refs when the completed request is no longer latest. Only the latest request may clear `loading`.

- [ ] **Step 4: Add a deferred-response regression test**
...
- [ ] **Step 1: Add one shared busy state**
...
- [ ] **Step 3: Make download cleanup browser-safe**
...
- [ ] **Step 4: Test filter snapshot and disabled controls**
...
- [ ] **Step 1: Add localized data labels to cells**
...
- [ ] **Step 2: Add the 640px mobile card rules**
...
- [ ] **Step 3: Add markup contract assertions**
...
- [ ] **Step 2: Run real-component visual QA**
