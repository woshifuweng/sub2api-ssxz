...
import { formatCountdown, formatDate, formatDateTime, formatCountdownWithSuffix, formatTime } from '@/utils/format'

// 上游 v0.1.165 使用 utils/format 中的 formatDateTimeToMinute；
// 生产分支的 format.ts 未保留该导出，这里以 formatDate 本地实现同等行为（精确到分钟）。
const formatDateTimeToMinute = (date: string | Date | null | undefined): string => {
