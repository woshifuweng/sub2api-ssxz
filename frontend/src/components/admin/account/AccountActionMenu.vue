      ...
      >
        <div class="py-1">
          <template v-if="account">
            ...
            <!-- Linked shadow accounts do not own credentials, so credential actions are invalid. -->
...
const emit = defineEmits(['close', 'test', 'refresh-models', 'stats', 'schedule', 'duplicate', 'reauth', 'refresh-token', 'recover-state', 'reset-quota', 'set-privacy', 'create-spark-shadow'])
const { t } = useI18n()
