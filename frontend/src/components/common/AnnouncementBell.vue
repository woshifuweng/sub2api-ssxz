<template>
  <div>
    ...
    <button
      ...
      :class="{ 'text-primary-700 dark:text-primary-200': unreadCount > 0 }"
      ...
      <Transition name="modal-fade">
        ...
        >
          ...
          >
            ...
            <div class="relative overflow-hidden border-b border-gray-100/80 bg-gray-50/80 px-6 py-5 dark:border-dark-700/50 dark:bg-dark-800/70">
              <div class="relative z-10 flex items-start justify-between">
                <div>
                  <div class="flex items-center gap-2">
                    <div class="flex h-8 w-8 items-center justify-center rounded-lg bg-primary-800 text-white shadow-sm dark:bg-primary-100 dark:text-primary-950">
                  ...
                  <p v-if="unreadCount > 0" class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                    <span class="font-medium text-primary-700 dark:text-primary-200">{{ unreadCount }}</span>
                ...
                <div class="flex items-center gap-2">
                  <button
                    ...
                    @click="markAllAsRead"
                    :disabled="loading"
                    class="rounded-lg bg-primary-900 px-4 py-2 text-xs font-medium text-white shadow-sm transition-colors hover:bg-primary-800 disabled:opacity-50 dark:bg-primary-100 dark:text-primary-950 dark:hover:bg-white"
                  >
            ...
            <div class="max-h-[65vh] overflow-y-auto">
              ...
              <div v-if="loading" class="flex items-center justify-center py-16">
                <div class="relative">
                  <div class="h-12 w-12 animate-spin rounded-full border-4 border-gray-200 border-t-primary-700 dark:border-dark-600 dark:border-t-primary-200"></div>
              ...
              <div v-else-if="announcements.length > 0">
                ...
                >
                  ...
                  <div class="flex h-10 w-10 flex-shrink-0 items-center justify-center">
                    <div
                      v-if="!item.read_at"
                      class="relative flex h-10 w-10 items-center justify-center rounded-xl bg-primary-800 text-white shadow-sm dark:bg-primary-100 dark:text-primary-950"
                    >
                      <!-- Pulse ring -->
                      <span class="absolute inline-flex h-full w-full animate-ping rounded-xl bg-primary-400 opacity-60"></span>
                      <!-- Icon -->
                      ...
                      <div class="mt-1 flex items-center gap-2">
                        ...
                        >
                          <span class="relative flex h-1.5 w-1.5">
                            ...
                            <span class="relative inline-flex h-1.5 w-1.5 rounded-full bg-primary-700 dark:bg-primary-200"></span>
                          </span>
                          {{ t('announcements.unread') }}
                        </span>
                      </div>
                  ...
                  <div
                    v-if="!item.read_at"
                    class="absolute left-0 top-0 h-full w-1 bg-primary-700 dark:bg-primary-300"
                  ></div>
                </div>
              </div>
      ...
      <Transition name="modal-fade">
        ...
        >
          ...
          >
            ...
            <div class="relative overflow-hidden border-b border-gray-100 bg-gray-50 px-8 py-6 dark:border-dark-700 dark:bg-dark-800">
              ...
              <div class="relative z-10 flex items-start justify-between gap-4">
                <div class="flex-1 min-w-0">
                  ...
                  <div class="mb-3 flex items-center gap-2">
                    <div class="flex h-10 w-10 items-center justify-center rounded-xl bg-primary-800 text-white shadow-sm dark:bg-primary-100 dark:text-primary-950">
                      <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                      </svg>
                    </div>
                    <div class="flex items-center gap-2">
                      ...
                      <span
                        ...
                        class="inline-flex items-center gap-1.5 rounded-lg bg-primary-800 px-2.5 py-1 text-xs font-medium text-white shadow-sm dark:bg-primary-100 dark:text-primary-950"
                      >
            ...
            <div class="max-h-[60vh] overflow-y-auto bg-white px-8 py-8 dark:bg-dark-800">
              ...
              <div class="relative">
                ...
                <div class="absolute bottom-0 left-0 top-0 w-1 rounded-full bg-primary-700 dark:bg-primary-300"></div>
              ...
              <div class="flex items-center justify-between">
                ...
                <div class="flex items-center gap-3">
                  ...
                  <button
                    ...
                    class="rounded-xl bg-primary-900 px-5 py-2.5 text-sm font-medium text-white shadow-sm transition-colors hover:bg-primary-800 dark:bg-primary-100 dark:text-primary-950 dark:hover:bg-white"
                  >
...
.markdown-body a {
  @apply font-medium text-primary-700 underline decoration-primary-600/30 decoration-2 underline-offset-2 transition-all hover:decoration-primary-700 dark:text-primary-300 dark:decoration-primary-300/30 dark:hover:decoration-primary-200;
}
...
.markdown-body blockquote {
  @apply relative my-5 border-l-4 border-primary-600 bg-primary-50/50 py-3 pl-5 pr-4 italic text-gray-700 dark:border-primary-300 dark:bg-primary-900/10 dark:text-gray-300;
}

.markdown-body blockquote::before {
  content: '"';
  @apply absolute -left-1 top-0 text-5xl font-serif text-primary-500/20 dark:text-primary-300/20;
}
...
.markdown-body th {
  @apply bg-primary-50 font-semibold text-gray-900 dark:bg-primary-900/20 dark:text-white;
}
