...
const riskControlEnabled = computed(() => !!appStore.cachedPublicSettings?.risk_control_enabled)
...
/* Custom SVG icon in sidebar: preserve uploaded colors and constrain size. */
.sidebar-svg-icon {
  color: currentColor;
}
