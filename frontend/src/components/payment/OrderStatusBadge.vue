...
const statusMap: Record<OrderStatus, { key: string; class: string }> = {
  ...
  PAID: { key: 'payment.status.paid', class: 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400' },
  RECHARGING: { key: 'payment.status.recharging', class: 'bg-primary-100 text-primary-800 dark:bg-primary-900/30 dark:text-primary-400' },
  ...
  PARTIALLY_REFUNDED: { key: 'payment.status.partially_refunded', class: 'bg-orange-100 text-orange-800 dark:bg-orange-900/30 dark:text-orange-400' },
