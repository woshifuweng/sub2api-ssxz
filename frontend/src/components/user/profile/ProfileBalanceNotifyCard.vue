    ...
    <div class="px-6 py-6 space-y-6">
      ...
      <div class="flex items-center justify-between">
        ...
        <Toggle
          ...
          :aria-label="t('profile.balanceNotify.enabled')"
            ...
            <div v-for="(entry, idx) in emailEntries" :key="idx"
              ...
              <div class="flex items-center gap-2 min-w-0 flex-1">
                <Toggle
                  ...
                  class="shrink-0"
                  @update:model-value="(enabled) => handleEmailToggle(entry, enabled)"
                />
...
async function handleEmailToggle(entry: NotifyEmailEntry, enabled: boolean) {
