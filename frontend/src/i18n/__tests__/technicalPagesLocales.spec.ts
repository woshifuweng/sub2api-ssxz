...
describe('technical user page locale copy', () => {
  const requiredKeys = [
    ...
    'availableChannels.columns.model',
    'availableChannels.columns.provider',
    'availableChannels.columns.group',
    'availableChannels.columns.input',
    'availableChannels.columns.output',
