export default {
  ...
  nav: {
    ...
    orderManagement: 'Recharge Orders',
    paymentPlans: 'Plan Settings',
  ...
  affiliate: {
    ...
    loadFailedTitle: 'Referral rewards are temporarily unavailable',
    loadFailedBody: 'Refresh to reload your referral code and invite history. Existing records remain intact.',
    reload: 'Reload',
    currentRate: 'Current reward rate',
    rateHint: 'Final rewards follow the recorded settlement data',
    inviteCount: 'Invitees',
    inviteCountHint: 'People registered through your link',
    availableQuota: 'Available rewards',
    availableQuotaHint: 'Can be transferred to account balance',
    totalRewards: 'Total rewards',
    pending: 'Pending: {amount}',
    exclusiveInvite: 'Your referral',
    inviteDescription: 'Share your referral link with customers. Registrations through the link are tracked automatically, and eligible rewards become available under the active rules.',
    code: 'Referral code',
    link: 'Referral link',
    copy: 'Copy',
    codeCopied: 'Referral code copied',
    linkCopied: 'Referral link copied',
    settleTitle: 'Transfer to balance',
    settleDescription: 'Move available rewards into your account balance for API usage. Pending rewards become available after meeting the active rules.',
    settling: 'Transferring...',
    transfer: 'Transfer',
    recordsTitle: 'Invite history',
    recordsDescription: 'Customers registered through your referral link and their credited rewards appear here. Final amounts follow settlement records.',
    noRecords: 'No invite history yet.',
    user: 'User',
    name: 'Name',
    creditedReward: 'Credited reward',
  ...
  auth: {
    ...
    portalDescription: 'Use one account and one set of keys to reach the models you rely on every day.',
  ...
  keys: {
    ...
    enableKeyTitle: 'Enable API Key',
    disableKeyTitle: 'Disable API Key',
    enableConfirmMessage: 'Enable API key "{name}"? This key will be able to call enabled models again.',
    disableConfirmMessage: 'Disable API key "{name}"? Third-party clients using this key will stop working until it is enabled again.',
    apiKey: 'API Key',
    group: 'Group',
    noGroup: 'No group',
    ...
    useKeyModal: {
      ...
      thirdParty: {
        ...
        modelLabel: 'Model',
        modelHint: 'Use models available to your account package.',
    ...
    quotaAmountHint: 'Set this API Key self-limit only. 0 means no extra key-level quota, but account balance, group rules, and backend policies still apply; this does not change billing history or account balance.',
    quotaUsed: 'Quota Used',
    reset: 'Reset',
    resetQuotaUsed: 'Reset used quota to 0',
    resetQuotaTitle: 'Confirm Reset Quota',
    resetQuotaConfirmMessage: 'Reset the API Key self-limit counter (${used}) for "{name}" to 0? This does not delete usage history, change bills, or refund balance.',
    ...
    rateLimitHint: 'Set this API Key self-limit within each time window. 0 means no extra limit for that window, but account balance, group rules, and backend policies still apply; this does not change billing history or account balance.',
    rateLimitUsage: 'Rate Limit Usage',
    resetRateLimitUsage: 'Reset Rate Limit Usage',
    resetRateLimitTitle: 'Confirm Reset Rate Limit',
    resetRateLimitConfirmMessage: 'Reset the API Key rate-limit counters for "{name}"? This only clears time-window counters and does not delete usage history, change bills, or refund balance.',
  ...
  usage: {
    ...
    workbench: {
      ...
      subtitle: 'Review account balance, current-month spend, and recent usage. When no usage records exist, this page shows an empty state and never jumps to the legacy usage page.',
      ...
      monthlyUsageSummary: 'This month: {requests} requests and {tokens} usage units.',
      statsLoadError: 'Monthly usage stats are temporarily unavailable. Refresh to retry.',
      billingExplanationTitle: 'Billing explanation',
      billingExplanationDescription: 'Usage records show the final charge result. Completed calls display the charged amount; failed or unfinished requests are not shown as charged.',
      billingExplanationItems: {
        successCharged: 'Completed calls show the final charge in usage details.',
        failureNoCharge: 'Failed or unfinished requests show as no charge, or do not create a charge record.',
        zeroCost: 'A $0.0000 fee means no balance was deducted for this row.'
      },
      monthlyUsageTitle: 'Daily usage trends',
      monthlyUsageDescription: 'Real daily records with period controls for spend, requests, and token usage.',
      realDataBadge: 'Real data',
      demoDataBadge: 'Sample data',
      monthlyChartLabel: 'Daily usage trend charts',
      dailyCostTrend: 'Daily actual spend',
      dailyRequestTrend: 'Daily requests',
      dailyTokenTrend: 'Daily token usage',
      actualChargeTrendHint: 'Final balance deductions only',
      requestTrendHint: 'Successful records grouped by day',
      tokenTrendHint: 'Input, output, and cache tokens combined',
      period7Days: 'Past 7 days',
      period30Days: 'Past 30 days',
      period90Days: 'Past 90 days',
      periodAll: 'All available days',
      periodSelectLabel: 'Select reporting period',
      viewToggleLabel: 'Switch chart view',
      curveView: 'Curve view',
      barView: 'Bar view',
      low: 'Low',
      average: 'Average',
      peak: 'Peak',
      noMonthlyUsageTitle: 'No usage trend data yet',
      noMonthlyUsageDescription: 'After chat, image generation, or third-party client calls create real usage, trends appear here.',
      trendLoadError: 'Usage trends are temporarily unavailable',
      ...
      usageDetailsDescription: 'Shows recent usage records so you can review model, type, usage, and charge result.',
      refresh: 'Refresh',
      loading: 'Loading usage',
      detailsLoadError: 'Usage details are temporarily unavailable',
      detailsLoadErrorHint: 'Refresh later. This page will not jump to the legacy usage page.',
      noDetailsTitle: 'No usage details yet',
      noDetailsDescription: 'Real calls will appear here after they are recorded.',
      ...
      billingBalance: 'Balance charge',
      billingSubscription: 'Subscription quota',
      billingNoCharge: 'No balance charged',
      standardVsActual: 'Actual charge {actual}',
      actualChargeBasis: 'Actual charge {amount}',
      noChargeBasis: 'No balance was deducted for this row.',
      performance: 'Processing time',
      performanceHealthy: 'Normal',
      performanceUnknown: 'No record',
      performanceSlowFirstToken: 'Slightly slower start',
      performanceSlowTotal: 'Longer processing',
      performanceNoRecord: 'No displayable timing yet',
      performanceSummary: 'Started in {firstToken}; total time {duration}',
      performanceSlowFirstTokenHint: 'This task was slightly slower to start, usually because of model tier, task complexity, or extra processing steps. For faster replies, use a lighter model or lower reasoning effort.',
      performanceSlowTotalHint: 'This task took longer, usually because it did more checking or used more steps. For faster replies, use a lighter model, lower reasoning effort, or shorten one-shot input.',
      ...
      fee: 'Fee',
      noCharge: 'No charge',
      zeroTokenCharged: 'Image / fixed-fee item',
      usageKindImage: 'Image generation',
      usageKindChat: 'Chat',
      usageKindThirdParty: 'Third-party access',
      usageKindWeb: 'Web app',
  ...
  // Payment
  payment: {
    tabTopUp: 'Top up balance',
    tabSubscribe: 'Subscription',
    rechargeAccount: 'Recharge account',
    currentBalance: 'Current balance',
    notAvailable: 'Online recharge or subscription is not open yet. Use your existing balance or follow the available recharge instructions.',
    quickAmounts: 'Quick amounts',
    customAmount: 'Custom amount',
    enterAmount: 'Enter recharge amount',
    amountNoMethod: 'Please select a payment method',
    amountTooLow: 'Recharge amount must be at least {min}',
    amountTooHigh: 'Recharge amount must be no more than {max}',
    paymentMethod: 'Payment method',
    paymentAmount: 'Payment amount',
    fee: 'Fee',
    actualPay: 'Amount to pay',
    creditedBalance: 'Credited balance',
    rechargeRatePreview: 'This recharge will credit about ${usd}',
    createOrder: 'Create order',
    amountLabel: 'Amount',
    selectPlan: 'Select a plan',
    noPlans: 'No subscription plans are available',
    ...
    refundReasonPlaceholder: 'Enter the refund reason',
    confirmCancel: 'Confirm cancellation',
    stripePay: 'Stripe payment',
    stripeMissingParams: 'Missing Stripe payment parameters',
    ...
    allowUserRefund: 'Allow user refunds',
    refundEnabled: 'Refunds enabled',
    limitsTitle: 'Payment limits',
    limitsHint: 'Leave blank to use global limits.',
    limitsUseGlobal: 'Use global limit',
    limitsNoLimit: 'No limit',
    limitSingleMin: 'Single minimum',
    limitSingleMax: 'Single maximum',
    limitDaily: 'Daily limit',
    paymentGuideTrigger: 'Payment guide',
    guideCallLabel: 'Call guide',
    guideOpenLabel: 'Open guide',
    guideFallbackLabel: 'Fallback guide',
    validationNameRequired: 'Provider name is required',
    validationFieldRequired: 'Required config field is missing',
    field_notifyUrl: 'Notify URL',
    field_returnUrl: 'Return URL',
    field_certSerial: 'Certificate serial number',
    field_: 'Config field',
    stripeWebhookHint: 'Configure the webhook callback URL in the Stripe dashboard.',
    providerAlipay: 'Alipay',
    providerWxpay: 'WeChat Pay',
    providerStripe: 'Stripe',
    providerEasypay: 'Easypay',
    typeDisabled: 'Disabled',
    alipayGuideSummary: 'Choose the Alipay integration that matches the payment mode.',
    alipayGuideFaceToFaceTitle: 'Face-to-face Pay',
    alipayGuideFaceToFaceCall: 'Best for QR-code payment scenarios.',
    alipayGuideFaceToFaceOpen: 'Open Alipay and scan to pay.',
    alipayGuideFaceToFaceFallback: 'Use QR payment if the app cannot be opened.',
    alipayGuidePagePayTitle: 'Desktop web payment',
    alipayGuidePagePayCall: 'Best for desktop browser redirect payments.',
    alipayGuidePagePayOpen: 'Open the Alipay cashier.',
    alipayGuidePagePayFallback: 'Return and create a new order if redirect fails.',
    alipayGuideWapTitle: 'Mobile web payment',
    alipayGuideWapCall: 'Best for mobile browser payments.',
    alipayGuideWapOpen: 'Open the Alipay mobile payment page.',
    alipayGuideWapFallback: 'Copy the link into a browser if it cannot be opened.',
    wxpayGuideSummary: 'Choose the WeChat Pay integration that matches the payment mode.',
    wxpayGuideNote: 'WeChat Pay requires callback and authorization settings in the merchant platform.',
    wxpayGuideNativeTitle: 'Native QR payment',
    wxpayGuideNativeCall: 'Best for desktop QR-code payments.',
    wxpayGuideNativeOpen: 'Scan with WeChat to pay.',
    wxpayGuideNativeFallback: 'Create a new order if the QR code is unavailable.',
    wxpayGuideH5Title: 'H5 payment',
    wxpayGuideH5Call: 'Best for mobile browser payments.',
    wxpayGuideH5Open: 'Open the WeChat H5 payment page.',
    wxpayGuideH5Fallback: 'Switch browser and try again if it cannot be opened.',
    wxpayGuideJsapiTitle: 'JSAPI payment',
    wxpayGuideJsapiCall: 'Best for in-WeChat payments.',
    wxpayGuideJsapiOpen: 'Complete payment in WeChat.',
    wxpayGuideJsapiFallback: 'Open this page in WeChat and try again.',
    methods: {
      alipay: 'Alipay',
      wxpay: 'WeChat Pay',
      stripe: 'Stripe',
    ...
    qr: {
      ...
      scanAlipayHint: 'Use Alipay to scan and complete the payment',
      scanWxpay: 'Scan with WeChat Pay',
      scanWxpayHint: 'Use WeChat to scan and complete the payment',
      ...
      cancelledDesc: 'This order has been cancelled and no balance will be deducted.',
      expired: 'QR code expired',
      expiredDesc: 'Please create a new order.',
      openPayWindow: 'Open payment page',
    ...
    errors: {
      tooManyPending: 'There are too many pending orders. Please finish or cancel existing orders first.',
      cancelRateLimited: 'Too many operations. Please try again later.',
      mobilePaymentFallbackToQr: 'Mobile payment is unavailable. Switched to QR-code payment.',
      alipayDesktopQrHint: 'Use QR code payment for Alipay on desktop.',
      alipayDesktopUnavailable: 'Alipay desktop payment is unavailable.',
      alipayMobileOpenHint: 'Open the Alipay payment page in a mobile browser.',
      alipayMobileUnavailable: 'Alipay mobile payment is unavailable.',
      wechatH5NotAuthorized: 'WeChat H5 payment is not authorized.',
      wechatJsapiFailed: 'Failed to start WeChat JSAPI payment.',
      wechatJsapiUnavailable: 'WeChat JSAPI payment is unavailable.',
      wechatOpenInWeChatHint: 'Open this page in WeChat to continue payment.',
      wechatPaymentMpNotConfigured: 'WeChat official account payment is not fully configured.',
      wechatScanOnDesktopHint: 'Use WeChat to scan on desktop.',
      wechatSwitchBrowserHint: 'Switch to a browser that supports WeChat Pay.',
      wechatUnavailable: 'WeChat Pay is unavailable.'
    },
    recovery: {
      current: 'Current payment recovery'
    },
    stripePopup: {
      redirecting: 'Redirecting to Stripe...',
      loadingQr: 'Loading payment QR code...',
      timeout: 'Payment window timed out. Please return and try again.'
    },
    admin: {
      allOrderTypes: 'All order types',
      allPaymentTypes: 'All payment methods',
      allStatuses: 'All statuses',
      alreadyRefunded: 'Order already refunded',
      ...
      days: 'days',
      daySuffix: 'day',
      deductBalance: 'Deduct credited balance',
      deductBalanceHint: 'Deduct the credited user balance when refunding.',
      ...
      featuresPlaceholder: 'Example: higher concurrency\\nmore models',
      feeRate: 'Fee rate',
  ...
  profile: {
    ...
    workbench: {
      ...
      subtitle: 'Review account information and update profile, password, and security verification settings.',
      eyebrow: 'My account',
      introAriaLabel: 'Account settings explanation',
      introKicker: 'Account and security',
      introTitle: 'Manage your login information and security verification',
      introDescription: 'This page only handles your profile, password, and two-factor verification. Balance, usage, recharge, and API Key have their own sidebar entries so ordinary users do not accidentally enter the admin console.',
      basicInfoKicker: 'Basic info',
      accountInfoTitle: 'Account information',
      displayNameKicker: 'Display name',
      editProfileTitle: 'Edit profile',
      loginProtectionKicker: 'Login protection',
      changePasswordTitle: 'Change password',
      twoFactorKicker: 'Two-factor verification',
    ...
    avatar: {
      ...
      uploadTitle: 'Choose an avatar image',
      uploadButton: 'Choose image',
      uploadHint: 'JPEG, PNG, or WebP up to 5MB; you can also drop an image here',
      selectedFile: 'Selected: {name}',
      zoomLabel: 'Zoom',
      cropHint: 'The avatar is automatically centered and cropped from the image center, then re-encoded in your browser before upload.',
    ...
    totp: {
      ...
      statusLoadFailed: 'Two-factor status is temporarily unavailable',
      statusLoadFailedHint: 'The current enabled state cannot be confirmed. Refresh to retry; unknown status is not shown as not enabled.',
      retryStatus: 'Retry',
  ...
  admin: {
    apiKeyInventory: {
      ...
      description: 'Review key status, assigned groups, and actual customer spend',
      searchPlaceholder: 'Search name, user email, ID, or key suffix',
      ...
      summaryCost: 'Actual spend, 30 days',
      user: 'User / Balance',
      key: 'Key',
      group: 'Group',
      quota: 'Quota',
      todayCost: 'Today spend',
      last30DaysCost: '30-day spend',
      totalCost: 'Lifetime spend',
      status: 'Status',
      lastUsedAt: 'Last used',
      createdAt: 'Created',
      expiresAt: 'Expires',
      costBreakdown: 'Actual spend',
      activity: 'Status / Last used',
      lifecycle: 'Lifecycle',
      createdShort: 'Created',
      expiresShort: 'Expires',
      sortLastUsed: 'Sort: Last used',
      sortTodayCost: 'Sort: Today spend',
      sortLast30DaysCost: 'Sort: 30-day spend',
      sortTotalCost: 'Sort: Lifetime spend',
      sortCreatedAt: 'Sort: Created',
      ...
      empty: 'No API keys match these filters',
      loadFailed: 'Failed to load full-site API keys',
      actions: 'Actions',
      enableAction: 'Enable',
      disableAction: 'Disable',
      changeGroupAction: 'Change group',
      deleteAction: 'Delete',
      changeGroupTitle: 'Change key group',
      deleteTitle: 'Delete API Key',
      deleteConfirm: 'Delete “{name}” owned by {user}? The key will stop working immediately.',
      enableSuccess: 'API Key enabled',
      disableSuccess: 'API Key disabled',
      changeGroupSuccess: 'API Key group updated',
      deleteSuccess: 'API Key deleted',
      mutationFailed: 'API Key operation failed'
    },
    // Dashboard
    dashboard: {
    ...
    channelMonitor: {
      ...
      advanced: {
        ...
        sectionHint: 'Customize request headers and body to work around upstream client detection (for example, providers that only allow Claude Code clients).',
        ...
        headersHint: 'One Key: Value pair per line; merged on top of adapter defaults (user wins). Hop-by-hop headers (Host / Content-Length / ...) are ignored.',
        headersParseError: 'Cannot parse line: {line}',
        headerNameInvalid: 'Invalid header name: {name}',
    ...
    subscriptions: {
      ...
      bulkAssign: {
        ...
        users: 'Select Users',
        searchPlaceholder: 'Search by email and select multiple users',
        selectedCount: '{count} user(s) selected',
        clearSelection: 'Clear selection',
        noUsersSelected: 'Search for users and add them to this assignment.',
        removeUser: 'Remove user',
        confirmTitle: 'Confirm Bulk Assignment',
        confirmMessage: 'Assign “{group}” to {count} user(s) for {days} days? Existing matching subscriptions will be reused according to server rules.',
        confirmAction: 'Confirm Assignment',
        continue: 'Continue',
        success: 'Bulk assignment complete: {created} created, {reused} reused',
        partialSuccess: 'Bulk assignment partially completed: {success} succeeded, {failed} failed',
        failed: 'Failed to bulk assign subscriptions'
      },
    ...
    accounts: {
      ...
      bulkActions: {
        ...
        updateCredentials: 'Update Credential Fields',
        resetStatusSuccess: 'Successfully reset {count} account(s) status',
        refreshTokenSuccess: 'Successfully refreshed {count} account(s) token',
        partialSuccess: 'Partially completed: {success} succeeded, {failed} failed'
      },
      batchCredentials: {
        title: 'Batch Update Credential Fields',
        selectedCount: '{count} selected account(s) will be updated',
        field: 'Field to update',
        fieldHint: 'Only the three server-approved fields are available. API keys, base URLs, and other credentials are not changed.',
        value: 'New value',
        valuePlaceholder: 'Enter a new value',
        valuePrivacyHint: 'Current values are never loaded or shown, and the input is omitted from confirmation.',
        clearValue: 'Clear this field',
        fields: {
          accountUuid: 'Account UUID',
          orgUuid: 'Organization UUID',
          interceptWarmup: 'Intercept warmup requests'
        },
        confirmTitle: 'Confirm Batch Update',
        confirmMessage: 'Update “{field}” for {count} account(s)? The entered value is hidden from this confirmation.',
        ...
        failed: 'Failed to batch update credential fields'
      },
      bulkEdit: {
    ...
    announcements: {
      ...
      noAnnouncementsDescription: 'Create your first announcement to share important information with users.',
      createFirstAnnouncement: 'Create your first announcement',
      retry: 'Retry',
      retryHint: 'Announcements could not be loaded. Please try again.',
    ...
    settings: {
      ...
      purchase: {
        ...
        xianyu10: 'Xianyu Purchase Link · ¥10',
        xianyu30: 'Xianyu Purchase Link · ¥30',
        xianyu100: 'Xianyu Purchase Link · ¥100',
        xianyuPlaceholder: 'https://www.goofish.com/item?id=...',
        iframeWarning:
  ...
  purchase: {
    ...
    notEnabledDesc: 'Online recharge or subscription is not open yet. Use your existing balance or follow the available recharge instructions.',
    notConfiguredTitle: 'Recharge / Subscription URL not configured',
    notConfiguredDesc:
      'The recharge/subscription entry is not fully configured yet. Use your existing balance or follow the available recharge instructions.',
  ...
  availableChannels: {
    ...
    providerTabsLabel: 'Filter by provider',
    allProviders: 'All',
    groupSearchPlaceholder: 'Search groups...',
    groupSearchEmpty: 'No matching groups',
    groupDescriptionFallback: 'No group description',
    cacheWriteShort: 'Write',
    cacheReadShort: 'Read',
    maxOutputShort: 'Output',
