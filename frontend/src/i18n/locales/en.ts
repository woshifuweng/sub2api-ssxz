export default {
  ...
  usage: {
    ...
    workbench: {
      ...
      subtitle: 'Review account balance, current-month spend, and recent usage. When no real usage data exists, this page shows an empty state and never jumps to the legacy usage page.',
      ...
      noRealUsageNote: 'No real usage records this month.',
      monthlyUsageSummary: 'This month: {requests} requests and {tokens} tokens.',
      ...
      billingExplanationDescription: 'This page uses backend-recorded real usage as the source of truth. Balance changes are calculated from model, usage, and backend rates; the frontend does not decide prices.',
      billingExplanationItems: {
        successCharged: 'Successful calls show the actual charge in usage details.',
        failureNoCharge: 'Failed requests or requests without real usage show as no charge, or do not create a charge record.',
        zeroCost: 'A $0.0000 fee means this record was not actually charged.'
      },
      ...
      trendLoadErrorHint: 'Details and balance can still be refreshed separately; API failures are not presented as an empty trend.',
      usageDetailsTitle: 'Usage details',
      usageDetailsDescription: 'Shows recent real usage records so you can verify model, type, usage, and charge.',
      refresh: 'Refresh',
      ...
      standardVsActual: 'Standard {standard}; charged {actual}',
      actualChargeBasis: 'Charged {amount}',
      noChargeBasis: 'No balance was deducted for this row.',
      performance: 'Latency',
      performanceHealthy: 'Normal',
      performanceUnknown: 'No record',
      performanceSlowFirstToken: 'Slow first token',
      performanceSlowTotal: 'Long total duration',
      performanceNoRecord: 'No backend latency detail yet',
      performanceSummary: 'TTFT {firstToken}; total {duration}',
      performanceSlowFirstTokenHint: 'First token is over 5 seconds; check upstream account, model, or channel first.',
      performanceSlowTotalHint: 'First token is normal but total duration is long. This is often caused by web search, tool calls, large context, or long model reasoning.',
      fee: 'Fee',
      noCharge: 'No charge',
  ...
  payment: {
    ...
    currentBalance: 'Current balance',
    notAvailable: 'Recharge and subscription are not enabled yet. Please contact the administrator.',
