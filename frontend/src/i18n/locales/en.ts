export default {
  ...
  keys: {
    ...
    quotaAmountHint: 'Set this API Key self-limit only. 0 = unlimited; this does not change billing history or account balance.',
    ...
    rateLimitHint: 'Set this API Key self-limit within each time window. 0 = unlimited; this does not change billing history or account balance.',
