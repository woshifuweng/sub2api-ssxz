  ...
  keys: {
    ...
    useKeyModal: {
      ...
      thirdParty: {
        ...
        quickStartDescription: 'Most clients only need these four items. If the client offers both a homepage and an API request URL, keep the API request URL as the Base URL shown here.',
        ...
        ccSwitchQuickOfficialSite: 'Homepage / official link: enter this site domain.',
        ccSwitchQuickRequestUrl: 'API request URL: enter the Base URL above.',
