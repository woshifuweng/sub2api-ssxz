...
import dashboardLocale from './en/dashboard'
import adminOverviewLocale from './en/admin/overview'
import adminOpsLocale from './en/admin/ops'
import adminSettingsLocale from './en/admin/settings'
import adminChannelsLocale from './en/admin/channels'
...
export default {
  ...
  nav: {
    ...
    reseller: 'Reseller',
    resellerManager: 'Team',
    resellerAdmin: 'Resellers',
  ...
  usage: {
    ...
    workbench: {
      ...
      usageDetailsDescription: 'Shows time, model, usage, duration, and final charge by default. Click any record for endpoint, support code, billing basis, and full timing details.',
      refresh: 'Refresh',
      ...
      duration: 'Duration',
      fee: 'Fee',
      feeTooltip: 'This column shows the final charge only. A $0.0000 fee means no balance was deducted; click the record for the complete billing basis.',
  ...
  // Admin
  admin: {
    riskControl: adminChannelsLocale.riskControl,
    ...promptAuditLocale,
    apiKeyInventory: {
