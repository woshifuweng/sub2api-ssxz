export default {
  ...
  keys: {
    ...
    workbenchGuide: {
      ...
      baseUrlRootLabel: 'Base URL (Claude Code / Codex CLI)',
      copyBaseUrlRoot: 'Copy Base URL (Claude Code / Codex CLI)',
      baseUrlRootCopied: 'Base URL (no /v1) copied',
  ...
  usage: {
    ...
    workbench: {
      ...
      usageDetailsDescription: 'Shows recent usage records so you can review model, usage, and charge result. Completed calls are charged by actual usage; failed or unfinished requests are not charged. Click any row for third-party source, support code, and billing details.',
      refresh: 'Refresh',
      ...
      duration: 'Duration',
      fee: 'Fee',
      feeTooltip: 'Only completed calls are charged; a $0.0000 fee means no balance was deducted for this row. Failed or unfinished requests create no charge.',
