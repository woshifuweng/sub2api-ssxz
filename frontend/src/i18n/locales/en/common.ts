export default {
  ...
  nav: {
    ...
    imageWorkbenchNoKey: 'No available API key',
    imageWorkbenchKeyError: 'Failed to load API keys',
    resellerAgent: 'My Rebates',
    resellerRecruits: 'Recruit Records',
    resellerWithdrawals: 'Withdrawal Records',
    resellerAdminWithdrawals: 'Reseller Withdrawals',
  },
