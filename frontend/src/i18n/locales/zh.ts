export default {
  ...
  usage: {
    ...
    workbench: {
      ...
      performanceSlowFirstToken: '首 token 偏慢',
      performanceSlowTotal: '总耗时偏长',
      performanceNoRecord: '后端暂无耗时明细',
      performanceSummary: '首 token {firstToken}；总耗时 {duration}',
      performanceSlowFirstTokenHint: '首 token 已超过 5 秒，优先检查上游账号、模型或通道。',
      performanceSlowTotalHint: '首 token 正常但总耗时较长，通常是联网搜索、工具调用、大上下文或模型长思考。',
      fee: '扣费',
      noCharge: '未扣费',
