export default {
  ...
  usage: {
    ...
    workbench: {
      ...
      unavailable: '暂不可用',
      noRealUsageNote: '本月暂未产生真实用量记录。',
      monthlyUsageSummary: '本月 {requests} 次请求，{tokens} tokens。',
      statsLoadError: '本月统计暂时无法加载，请刷新重试。',
      billingExplanationTitle: '扣费说明',
      billingExplanationDescription: '这里以后端已记录的真实用量为准。余额变化由模型、用量和后台费率计算，前端不决定价格。',
      billingExplanationItems: {
        successCharged: '成功调用会在明细中显示实际扣费。',
        failureNoCharge: '失败或未产生真实用量的请求会显示为未扣费，或不产生扣费记录。',
        zeroCost: '扣费为 $0.0000 表示本条记录未实际扣费。'
      },
      ...
      trendLoadErrorHint: '明细和余额仍可单独刷新；这里不会把接口失败显示成空趋势。',
      usageDetailsTitle: '用量明细',
      usageDetailsDescription: '展示最近的真实调用记录，方便核对模型、类型、用量和扣费。',
      refresh: '刷新',
      loading: '正在加载用量',
      ...
      standardVsActual: '标准 {standard}；实扣 {actual}',
      actualChargeBasis: '实扣 {amount}',
      noChargeBasis: '本条记录未扣除余额。',
      performance: '响应耗时',
      performanceHealthy: '正常',
      performanceUnknown: '暂无记录',
      performanceSlowFirstToken: '开始较慢',
  ...
  payment: {
    ...
    currentBalance: '当前余额',
    notAvailable: '管理员暂未开启充值/订阅入口，请联系管理员。',
    quickAmounts: '快捷金额',
    customAmount: '自定义金额',
    enterAmount: '请输入充值金额',
