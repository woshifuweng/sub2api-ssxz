...
import dashboardLocale from './zh/dashboard'
import adminOverviewLocale from './zh/admin/overview'
import adminOpsLocale from './zh/admin/ops'
import adminSettingsLocale from './zh/admin/settings'
import adminChannelsLocale from './zh/admin/channels'
...
export default {
  ...
  usage: {
    ...
    workbench: {
      ...
      usageDetailsDescription: '默认展示时间、模型、用量、耗时和实际扣费；点击任意记录可查看接口、定位码、计费依据和完整耗时。',
      refresh: '刷新',
      loading: '正在加载用量',
      ...
      duration: '耗时',
      fee: '扣费',
      feeTooltip: '这里只显示最终实际扣费。费用为 $0.0000 表示本条未扣除余额；点击记录可查看完整计费依据。',
      expandRow: '展开详情',
      collapseRow: '收起详情',
      detailNote: '备注',
