export default {
  ...
  usage: {
    ...
    workbench: {
      ...
      billingExplanationTitle: '扣费说明',
      billingExplanationDescription: '用量记录展示最终扣费结果。成功调用会显示扣费，失败或未完成的请求不会显示为已扣费。',
      billingExplanationItems: {
        successCharged: '成功完成的调用会在明细中显示最终扣费。',
        failureNoCharge: '失败或未完成的请求会显示为未扣费，或不产生扣费记录。',
        zeroCost: '费用为 $0.0000 表示本条没有扣除余额。'
      },
      ...
      usageDetailsDescription: '展示最近调用记录，方便查看模型、类型、用量和扣费结果。',
      refresh: '刷新',
      loading: '正在加载用量',
