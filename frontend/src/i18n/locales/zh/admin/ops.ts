export default {
    ops: {
      ...
      runtime: {
        ...
        metricThresholdsHint: '配置运行指标的告警阈值。',
        slaMinPercent: 'SLA 最低百分比',
        slaMinPercentHint: 'SLA 低于此值时触发告警。',
        ttftP99MaxMs: 'TTFT P99 最大值（毫秒）',
        ttftP99MaxMsHint: 'TTFT P99 高于此值时触发告警。',
        requestErrorRateMaxPercent: '请求错误率最大值（%）',
        requestErrorRateMaxPercentHint: '请求错误率高于此值时触发告警。',
        upstreamErrorRateMaxPercent: '上游错误率最大值（%）',
        upstreamErrorRateMaxPercentHint: '上游错误率高于此值时触发告警。',
        alertTitle: '告警评估器',
