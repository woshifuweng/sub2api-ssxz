export default {
    settings: {
      ...
      registration: {
        ...
        frontendUrlMissingWarning: '前端地址不能为空，否则密码重置邮件无法生成有效链接。',
        frontendUrlLatentWarning: '请确认该地址是用户实际访问的前端网址。',
        frontendUrlInvalidHint: '必须填写完整的 http:// 或 https:// 地址。',
        frontendUrlInvalidError: '前端地址无效，请填写完整的 http:// 或 https:// 地址。',
        totp: '双因素认证 (2FA)',
      ...
      site: {
        ...
        contactInfoMissingHint: '建议填写客服联系方式，避免用户无法登录时没有申诉渠道。',
        docUrl: '文档链接',
