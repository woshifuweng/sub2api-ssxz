      ...
      <div class="grid grid-cols-1 gap-3 md:grid-cols-2">
        <div>
          <label
            ...
            >{{ t("admin.backup.s3.endpoint") }}</label
          >
          <input
        ...
        <div>
          <label
            class="mb-1 block text-xs font-medium text-gray-600 dark:text-gray-400"
            >{{ t("admin.backup.s3.region") }}</label
          >
          <input
        ...
        <div>
          <label
            class="mb-1 block text-xs font-medium text-gray-600 dark:text-gray-400"
            >{{ t("admin.backup.s3.bucket") }}</label
          >
        ...
        <div>
          <label
            class="mb-1 block text-xs font-medium text-gray-600 dark:text-gray-400"
            >{{ t("admin.backup.s3.prefix") }}</label
          >
          <input
        ...
        <div>
          <label
            class="mb-1 block text-xs font-medium text-gray-600 dark:text-gray-400"
            >{{ t("admin.backup.s3.accessKeyId") }}</label
          >
        ...
        <div>
          <label
            class="mb-1 block text-xs font-medium text-gray-600 dark:text-gray-400"
            >{{ t("admin.backup.s3.secretAccessKey") }}</label
          >
          <input
    ...
    <div class="card p-6">
      ...
      <div class="grid grid-cols-1 gap-3 md:grid-cols-2">
        ...
        <div>
          <label
            class="mb-1 block text-xs font-medium text-gray-600 dark:text-gray-400"
            >{{ t("admin.backup.schedule.cronExpr") }}</label
          >
          <input
        ...
        <div>
          <label
            class="mb-1 block text-xs font-medium text-gray-600 dark:text-gray-400"
            >{{ t("admin.backup.schedule.retainDays") }}</label
          >
          <input
        ...
        <div>
          <label
            class="mb-1 block text-xs font-medium text-gray-600 dark:text-gray-400"
            >{{ t("admin.backup.schedule.retainCount") }}</label
          >
          <input
  ...
  <teleport to="body">
    <transition name="modal">
      ...
      >
        ...
        ></div>
        <div
          class="relative max-h-[85vh] w-full max-w-2xl overflow-y-auto rounded-xl bg-white p-6 shadow-2xl dark:bg-dark-800"
        >
          <LiquidButton
            type="button"
          ...
          <div class="mb-5">
            ...
            >
              <span
                class="flex h-6 w-6 items-center justify-center rounded-full bg-primary-100 text-xs font-bold text-primary-700 dark:bg-primary-900/40 dark:text-primary-300"
                >1</span
              >
              {{ t("admin.backup.r2Guide.step1.title") }}
            </h3>
            <ol
              class="ml-8 list-decimal space-y-1 text-sm text-gray-600 dark:text-gray-300"
            >
          ...
          <div class="mb-5">
            ...
            <code
              class="ml-8 mt-1 block rounded bg-gray-100 px-3 py-2 text-xs text-gray-800 dark:bg-dark-700 dark:text-gray-200"
              >https://&lt;{{
          ...
          <div class="mb-5">
            ...
            <div
              class="ml-8 overflow-hidden rounded-lg border border-gray-200 dark:border-dark-600"
            >
              <table class="w-full text-sm">
                <tbody>
                  ...
                  >
                    <td
                      class="whitespace-nowrap bg-gray-50 px-3 py-2 font-medium text-gray-700 dark:bg-dark-700 dark:text-gray-300"
                    >
                      {{ row.field }}
                    </td>
