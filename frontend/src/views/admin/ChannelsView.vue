        ...
        >
          ...
          <div v-show="activeTab === 'basic'" class="space-y-5">
            ...
            <div class="space-y-3">
              <label class="input-label mb-0">{{
                t("admin.channels.form.platformConfig")
              }}</label>
          ...
          >
            ...
            <div>
              ...
              <div
                class="max-h-40 overflow-auto rounded-lg border border-gray-200 bg-gray-50 p-2 dark:border-dark-600 dark:bg-dark-900"
              >
                <div
                  v-if="groupsLoading"
            ...
            <div
              class="mt-4 border-t border-gray-200 pt-4 dark:border-dark-700 space-y-3"
            >
              <div class="flex items-center justify-between">
                <h4
                  class="text-sm font-medium text-gray-700 dark:text-gray-300"
