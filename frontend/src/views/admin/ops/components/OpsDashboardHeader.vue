...
<template>
  <div
    :class="[
      'admin-b5-outline-panel flex flex-col gap-4 rounded-3xl bg-white shadow-sm ring-1 ring-gray-900/5 dark:bg-dark-800 dark:ring-dark-700',
  ...
  >
    ...
    >
      <div>
        ...
        >
          ...
          <span
            >{{ t("common.refresh") }}:
            {{ formatLastUpdated(props.lastUpdated) }}</span
          >
          ...
          >
            <span>·</span>
            <span>{{
              t("admin.ops.runtime.autoRefreshCountdown", {
                seconds: props.autoRefreshCountdown,
              })
            }}</span>
          </template>
        </div>
    ...
    <div v-if="overview" class="grid grid-cols-1 gap-6 xl:grid-cols-12">
      ...
      <div
        :class="[
          'min-w-0 rounded-2xl bg-gray-50 dark:bg-dark-900 xl:col-span-5',
      ...
      <div
        class="grid min-w-0 grid-cols-1 content-center gap-4 sm:grid-cols-2 xl:col-span-7 xl:grid-cols-3"
      >
        <!-- Card 1: Requests -->
        <div
