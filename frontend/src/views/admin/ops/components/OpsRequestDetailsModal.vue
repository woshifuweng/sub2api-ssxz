...
const fetchData = async () => {
  ...
  try {
    ...
    if (typeof props.preset.user_id === "number" && props.preset.user_id > 0)
      params.user_id = props.preset.user_id;
    if (
      typeof props.preset.api_key_id === "number" &&
      props.preset.api_key_id > 0
    )
      params.api_key_id = props.preset.api_key_id;
                ...
                >
                  ...
                  >
                    ...
                    >
                      {{
                        formatMetricMs(
                          isTTFTView ? row.first_token_ms : row.duration_ms,
                        )
                      }}
                    </td>
                    <td
