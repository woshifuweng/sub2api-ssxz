  ...
  >
          ...
          >
            <div class="flex items-center justify-between">
              <label
                ...
                >{{ t("admin.ops.settings.dailySummary") }}</label
              >
            ...
            <div class="flex items-center justify-between">
              <label
                class="text-sm font-medium text-gray-700 dark:text-gray-300"
                >{{ t("admin.ops.settings.weeklySummary") }}</label
              >
        ...
        <div class="space-y-4 px-4 pb-4">
          ...
          <div class="space-y-3">
            ...
            <div class="flex items-center justify-between">
              <label
                class="text-sm font-medium text-gray-700 dark:text-gray-300"
                >{{ t("admin.ops.settings.enableCleanup") }}</label
              >
              <Toggle
          ...
          <div class="space-y-3">
            ...
            <div class="flex items-center justify-between">
              <div>
                <label
                  class="text-sm font-medium text-gray-700 dark:text-gray-300"
                  >{{ t("admin.ops.settings.enableAggregation") }}</label
                >
                <p class="mt-1 text-xs text-gray-500">
          ...
          <div class="space-y-3">
            ...
            <div class="flex items-center justify-between">
              <div>
                <label
                  class="text-sm font-medium text-gray-700 dark:text-gray-300"
                  >{{ t("admin.ops.settings.ignoreCountTokensErrors") }}</label
                >
                <p class="mt-1 text-xs text-gray-500">
            ...
            <div class="flex items-center justify-between">
              <div>
                <label
                  class="text-sm font-medium text-gray-700 dark:text-gray-300"
                  >{{ t("admin.ops.settings.ignoreContextCanceled") }}</label
                >
                <p class="mt-1 text-xs text-gray-500">
          ...
          <div class="space-y-3">
            ...
            <div class="flex items-center justify-between">
              <div>
                <label
                  class="text-sm font-medium text-gray-700 dark:text-gray-300"
                  >{{ t("admin.ops.settings.enableAutoRefresh") }}</label
                >
                <p class="mt-1 text-xs text-gray-500">
          ...
          <div class="space-y-3">
            ...
            <div class="flex items-center justify-between">
              <div>
                <label
                  class="text-sm font-medium text-gray-700 dark:text-gray-300"
                  >{{ t("admin.ops.settings.displayAlertEvents") }}</label
                >
                <p class="mt-1 text-xs text-gray-500">
            ...
            <div class="flex items-center justify-between">
              <div>
                <label
                  class="text-sm font-medium text-gray-700 dark:text-gray-300"
                  >{{ t("admin.ops.settings.displayOpenAITokenStats") }}</label
                >
                <p class="mt-1 text-xs text-gray-500">
    ...
    <template #footer>
      <div class="flex justify-end gap-2">
        <LiquidButton @click="emit('close')" variant="outline" size="sm">{{
          t("common.cancel")
        }}</LiquidButton>
        <LiquidButton
