...
<template>
  <div
    class="admin-b5-outline-panel flex h-full flex-col rounded-3xl bg-white p-6 shadow-sm ring-1 ring-gray-900/5 dark:bg-dark-800 dark:ring-dark-700"
  >
    <div
      data-testid="throughput-chart-header"
      class="mb-4 flex shrink-0 flex-col items-start justify-between gap-3 sm:flex-row sm:items-center"
    >
      <h3
      ...
      <div
        ...
        class="flex w-full flex-wrap items-center gap-2 text-xs text-gray-500 dark:text-gray-400 sm:w-auto"
      >
