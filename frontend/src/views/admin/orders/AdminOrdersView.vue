  ...
  <AppLayout>
    ...
    <div class="space-y-4 admin-b4-outline-scope">
      ...
      <div class="card p-4">
        ...
        <div
          v-if="userIdFilter"
          class="mt-3 flex flex-wrap items-center gap-2 rounded-lg bg-primary-50 px-3 py-2 text-sm text-primary-700 dark:bg-primary-900/20 dark:text-primary-300"
        >
          ...
          <div class="flex items-center gap-1">
            ...
            <template v-if="row.status === 'REFUND_REQUESTED'">
              <span
                ...
                class="rounded-full bg-purple-100 px-1.5 py-0.5 text-xs font-medium text-purple-700 dark:bg-purple-900/30 dark:text-purple-300"
            ...
            <LiquidButton
              ...
              class="inline-flex items-center gap-1 rounded-md px-2 py-1 text-xs font-medium text-orange-600 hover:bg-orange-50 disabled:opacity-60 dark:text-orange-400 dark:hover:bg-orange-900/20"
              variant="plain"
              size="sm"
            >
              <Icon
                name="refresh"
                size="sm"
                :class="refundQueryingIds.has(row.id) ? 'animate-spin' : ''"
              />
    ...
    >
      <div v-if="selectedOrder" class="space-y-4">
        <div class="grid grid-cols-2 gap-4">
          ...
          <div
            class="col-span-2 flex flex-wrap gap-2 border-t border-gray-200 pt-3 dark:border-dark-600"
          >
            <LiquidButton
              type="button"
              @click="goToUserUsage(selectedOrder.user_id)"
              variant="outline"
              size="sm"
            >
            ...
            <LiquidButton
              type="button"
              @click="goToUserOrders(selectedOrder.user_id)"
              variant="outline"
              size="sm"
            >
          ...
          <div
            ...
            class="col-span-2 border-t border-gray-200 pt-3 dark:border-dark-600"
          >
            <p
              class="mb-2 text-xs font-medium text-purple-600 dark:text-purple-400"
            >
        ...
        >
          ...
          <div class="max-h-48 space-y-2 overflow-y-auto">
            <div
              ...
              :key="log.id"
              class="rounded-lg border border-gray-100 bg-gray-50 p-2.5 dark:border-dark-600 dark:bg-dark-800"
            >
              ...
              <div v-if="log.operator" class="mt-1 text-xs text-gray-400">
