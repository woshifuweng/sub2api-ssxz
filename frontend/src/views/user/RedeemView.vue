  ...
  <component :is="pageShell" v-bind="pageShellProps">
    <div class="redeem-workbench">
      <div class="card redeem-balance-card">
        ...
        <div class="min-w-0">
          <p class="redeem-balance-card__label">
            {{ t("redeem.currentBalance") }}
          </p>
          <p
            :class="[
              'redeem-balance-card__value',
              { 'redeem-balance-card__value--updated': balancePulse },
            ]"
          >
          ...
          <div class="p-6">
            <div class="flex items-start gap-4">
              ...
              <div class="min-w-0 flex-1">
                ...
                <div
                  class="mt-2 space-y-1 text-sm text-[var(--ssxz-text-secondary)]"
                >
                  <p class="font-medium">
      ...
      <div class="card redeem-info-card">
        <div class="p-6">
          <div class="flex items-start gap-4">
            <div class="redeem-info-card__icon">
              <Icon
                name="infoCircle"
                size="md"
        ...
        <div class="p-6">
          ...
          >
            <Icon
              name="refresh"
              size="lg"
              class="animate-spin text-[var(--ssxz-accent)]"
            />
          </div>
          ...
          <div v-else-if="historyLoadFailed" class="redeem-empty">
            ...
            <h3>
              {{ t("redeem.historyLoadFailedTitle", "记录暂时无法加载") }}
            </h3>
            <p>
          ...
          <div v-else-if="history.length > 0" class="space-y-3">
            ...
            >
              ...
              <div class="text-right">
                <p
                  :class="['text-sm font-semibold', 'text-[var(--ssxz-text)]']"
                >
...
import MetalButton from "@/components/common/MetalButton.vue";
...
const isBalanceType = (type: string) =>
  type === "balance" || type === "admin_balance";
